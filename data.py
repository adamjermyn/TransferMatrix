...
def data(name):
	if name=='h':
		...
		length = 100*np.array([4.6, 3.19, 2.61, 1.61, 1.2, 1.69, 1.68, 2.49, 3.16, 3.46])
		dl = 100*np.array([0.69, 0.29, 0.34, 0.13, 0.11, 0.13, 0.42, 0.13, 0.21, 0.34])
		...
		length = 100*np.array([5.56,3.85,2.94,2.73,2.68,3.24,4.03,4.16,4.09])
		dl = 100*np.array([0.45,0.26,0.37,0.3,0.22,0.52,0.27,0.23,0.38])
